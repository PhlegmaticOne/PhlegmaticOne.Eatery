...
public class RecipeController
{
    ...
    public RecipeController(Recipe recipe, StoragesContainerBase storageContainer, ProductionCapacityContainerBase productionCapacityContainer)
    {
    ...
    //            _productionCapacityContainer.DecreaseCapacity(process.GetType(), 1);
